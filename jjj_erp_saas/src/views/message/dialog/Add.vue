<template>
  ...
  <el-dialog title="添加消息" v-model="dialogVisible" @close='dialogFormVisible' :close-on-click-modal="false"
    ...
    <el-form size="small" :model="form" ref="form">
      ...
      <el-form-item label="通知对象" :label-width="formLabelWidth" :rules="[{required: true,message: ' '}]" prop="messageTo">
      ...
      <el-form-item label="消息类别" :label-width="formLabelWidth" :rules="[{required: true,message: ' '}]" prop="messageType">
