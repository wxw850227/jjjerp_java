<template>
	<el-dialog title="查看其他出库单单据详情" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		...
		<div class="common-seach-wrap">
			<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="客户地址" class="ww100">
		...
		<el-table size="small" :data="productData" border style="width: 100%" @selection-change="handleSelectionChange"
			...
			<el-table-column prop="productExtend.barCode" label="条码" width="100"   show-overflow-tooltip></el-table-column>
