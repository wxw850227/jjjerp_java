<template>
	<el-dialog title="调拨出库" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		:close-on-press-escape="false" :fullscreen="fullscreen" :show-close="false" align-center
		append-to="#right-content-box">
		<template #header="{ close, titleId, titleClass }">
			<div class="my-header d-b-c">
				<div :id="titleId" :class="titleClass" class="flex-1">调拨出库</div>
		...
		<div class="common-seach-wrap">
			<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
				<el-row>
					...
					<el-col :span="4"><el-form-item label="经手人">
							<el-input size="small" v-model="searchForm.remark" placeholder="请输入条码"
								></el-input> </el-form-item></el-col>
					<el-col :span="7"><el-form-item label="备注">
							<el-input size="small" v-model="searchForm.remark" placeholder="请输入条码"
								></el-input> </el-form-item></el-col>
				</el-row>
				<el-row>
		...
		<el-table size="small" :data="productData" border style="width: 100%" @selection-change="handleSelectionChange"
			...
			<el-table-column prop="availableNumber" label="可出库数量" width="100"></el-table-column>
			<el-table-column prop="availableAllNumber" label="可出库数量(pcs)" width="120"></el-table-column>
		...
		<template #footer>
			<div class="dialog-footer">
				<el-button type="primary" @click="editUser" :loading="loading">保 存</el-button>
	...
	export default {
		...
		methods: {
			...
			editUser() {
				...
				self.loading = true;
				StockApi.stockAllocateOutAdd(params, true)
					.then((data) => {
						self.loading = false;
						ElMessage({
							message: "添加成功",
