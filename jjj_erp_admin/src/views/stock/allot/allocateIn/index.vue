	...
	<div class="product bgset set-main">
		...
		<div class="common-seach-wrap">
			<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
				...
				<el-form-item label="调入仓库">
					<el-select size="small" v-model="searchForm.anotherDepotId" placeholder="请选择">
						<el-option v-for="(item, index) in depotList" :key="index" :label="item.name"
							:value="item.depotId" />
					</el-select>
				</el-form-item>
				<el-form-item label="调拨单号">
					<el-input size="small" v-model="searchForm.codeNum" placeholder="请输入调拨单号"></el-input>
				</el-form-item>
		...
		<div class="common-level-rail d-b-c">
			<div class="d-s-c flex-1">
				<el-button size="small" type="primary" @click="addClick"
					v-auth="'/product/base/unit/add'">调拨入库</el-button>
		...
		<el-table class="flex-1" size="small" :data="tableData" border style="width: 100%"
          ...
          ></el-table-column> -->
			...
			<el-table-column prop="businessTime" label="业务日期" width="130" show-overflow-tooltip></el-table-column>

			<el-table-column prop="codeNum" label="单据编号" width="150"  show-overflow-tooltip></el-table-column>
			...
			<el-table-column prop="typeName" label="关联调拨单"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			getData(param = "") {
				...
				StockApi.stockAllocateInList(Params, true)
					.then((res) => {
						self.loading = false;
