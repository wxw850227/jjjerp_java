<template>
	<el-dialog title="调拨出入库详情" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		...
		<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline mt10">
			<el-row>
				<el-col :span="6">
				...
				<el-col :span="6">
					<el-form-item label="其他费用" class="ww100">
						<el-input :disabled="openDetail" v-model="searchForm.otherMoney"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="6">
					<el-form-item label="" class="ww100">
