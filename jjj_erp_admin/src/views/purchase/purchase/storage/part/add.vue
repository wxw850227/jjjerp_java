<template>
	<el-dialog title="采购入库" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		:close-on-press-escape="false" :fullscreen="fullscreen" :show-close="false" align-center
		append-to="#right-content-box">
		<template #header="{ close, titleId, titleClass }">
			<div class="my-header d-b-c">
				<div :id="titleId" :class="titleClass" class="flex-1">采购入库</div>
	...
	export default {
		...
		methods: {
			...
			editUser() {
				...
				console.log(params, "params");
				self.loading = true;
				PurchaseApi.storageAdd(params, true)
					.then((data) => {
						self.loading = false;
						ElMessage({
							message: "添加成功",
