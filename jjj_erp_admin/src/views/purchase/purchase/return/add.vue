<template>
	<el-dialog title="新增退货订单" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		:close-on-press-escape="false" :fullscreen="fullscreen" :show-close="false" align-center
		append-to="#right-content-box">
		<template #header="{ close, titleId, titleClass }">
			<div class="my-header d-b-c">
				<div :id="titleId" :class="titleClass" class="flex-1">新增退货订单</div>
		...
		<div class="common-seach-wrap column-dialog">
			<div>
			<el-form size="small" :inline="true" :rules="formRules" ref="form" :model="searchForm"
			...
			<el-row>
				...
				<el-col :span="6">	
					...
					<el-form-item prop="accountId" label="结算账户">
						<el-select v-model="searchForm.accountId" style="width: 220px" placeholder="请选择">
