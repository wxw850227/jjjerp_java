<template>
	<el-dialog :title="opentitle" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
			...
			<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
				<el-row>
					<el-col :span="5">
						<el-form-item label="单据编号">
							<el-input size="small" v-model="searchForm.codeNum" :disabled="openDetail"
								placeholder="不填写则系统自动生成"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="5">
					...
					<el-col :span="5">
						<el-form-item label="供应商">
							<el-select :disabled="openDetail" v-model="searchForm.supplierId" placeholder="请选择">
				...
				<el-row>
					<el-col :span="10"><el-form-item label="备注" class="ww100">
							<el-input :disabled="openDetail" size="small" v-model="searchForm.systemRemark"
								placeholder="请输入备注"></el-input> </el-form-item></el-col>
					<el-col :span="10">
						<el-form-item label="银行账号" class="ww100">
							<el-input :disabled="openDetail" size="small" v-model="searchForm.barCode"
								placeholder="请输入条码"></el-input>
						</el-form-item></el-col>
				</el-row>
				<el-row>
					<el-col :span="8">
					...
					<!-- <el-col :span="4">
						<el-form-item>
							<el-button size="small" type="primary">商品清单</el-button>
						</el-form-item></el-col> -->
				</el-row>
			</el-form>
		</div>
		<el-table size="small" :data="productData" border style="width: 100%" @selection-change="handleSelectionChange"
			...
			<el-table-column prop="billItemId" label="ID" width="55"></el-table-column>
			...
			<el-table-column prop="imageUrl" label="图" width="42">
				<template #default="scope">
					...
					<el-image v-if="scope.row.imageUrl" style="width: 50px; height: 50px" :src="scope.row.imageUrl"
			...
			<el-table-column prop="basicNumber" label="数量(pcs)" width="100">
				<template #default="{ row }">
					<el-input :disabled="openDetail" disabled v-model="row.basicNumber" label="数量" />
				</template>
			</el-table-column>
			<el-table-column prop="productExtend.commodityDecimal" label="吊牌价" width="100">
			</el-table-column>
			<el-table-column prop="purchaseDecimal" label="单价" width="100"><template #default="{ row }">
					<el-input v-if="row.productExtend" :disabled="openDetail"
						v-model="row.productExtend.purchaseDecimal" label="单价" @blur="handleUnitPriceChange(row)" />
					<el-input v-else :disabled="openDetail" v-model="row.purchaseDecimal" label="单价"
      ...
      ></el-table-column> -->
			...
			<el-table-column prop="purchaseCycle" label="采购周期" width="120">
				<template #default="{ row }">
					<el-input :disabled="openDetail" v-model="row.purchaseCycle" @blur="handlePurchaseCycleChange(row)"
						label="采购周期">
						<template #append>
							<span>天</span>
						</template>
			...
			<el-table-column prop="arrivalDate" label="预计到货日期" width="120"><template #default="{ row }">
					<el-date-picker :disabled="openDetail" v-model="row.arrivalDate" type="date" placeholder="请选择" />
				</template>
			</el-table-column>
			...
			<el-row>
				<el-col :span="9">
					<el-form-item label="采购运费">
						<el-input :disabled="openDetail" v-model="searchForm.purchaseMoney"
							placeholder="商品名称"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="6">
					<el-form-item>
						<el-select :disabled="openDetail" v-model="searchForm.purchaseAllotType" placeholder="请选择">
				...
				<el-col :span="9">
					<el-form-item label="结算账户">
						<el-select :disabled="openDetail" v-model="searchForm.accountId" placeholder="请选择">
			...
			<el-row>
				<el-col :span="9">
					<el-form-item label="其他费用">
						<el-input :disabled="openDetail" v-model="searchForm.otherMoney" placeholder="商品名称"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="6">
					<el-form-item>
						<el-select :disabled="openDetail" v-model="searchForm.otherAllotType" placeholder="请选择">
							<el-option label="不分摊" :value="0"></el-option>
							<el-option label="按金额分摊" :value="1"></el-option>
							<el-option label="按重量分摊" :value="2"></el-option>
						</el-select>
				...
				<el-col :span="9">
					<el-form-item label="预付金额">
						<el-input :disabled="openDetail" v-model="searchForm.deposit" placeholder="商品名称"></el-input>
					</el-form-item>
				</el-col>
			</el-row>
...
<script>
	...
	export default {
		...
		created() {
			...
			if (this.openDetail) {
				this.opentitle = "采购订单详情";
			} else {
				this.opentitle = "编辑采购订单";
			}
			this.searchForm = {
				...this.editForm,
			};
		...
		methods: {
			...
			editUser() {
				...
				let billItemList = self.productData.map((option) => ({
					...
					purchaseDecimal: option.productExtend ?
						option.productExtend.purchaseDecimal :
						option.purchaseDecimal,
