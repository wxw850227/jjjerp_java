				...
				<div class="table-wrap">
					<div v-if="activeName == 'detail'">
						<el-table size="small" :data="filteredBillItems" border style="width: 100%"
							...
							<el-table-column prop="productExtend.productCode" label="规格编码" show-overflow-tooltip></el-table-column>
							...
							<el-table-column prop="barCode" label="规格条码" show-overflow-tooltip></el-table-column>
