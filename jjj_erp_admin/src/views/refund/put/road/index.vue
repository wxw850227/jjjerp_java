<template>
  <el-form size="small" ref="form" :model="form">
    <el-container>
      ...
      <el-main
        style="height: 100vh; background-color: #fff; margin-left: 10px;padding:12px;"
          ...
          <div>
            ...
            <div class="pt16">
              ...
              >
                ...
                <el-table-column label="可入库总数" :span="1">
                  <template #default="scope">
                ...
                <el-table-column label="商品编码" :span="1">
                  <template #default="scope">
                    <p class="text-ellipsis-2">
