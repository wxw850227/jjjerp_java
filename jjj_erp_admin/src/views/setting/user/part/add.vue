          ...
          >
            ...
            <el-table-column prop="name" label="收件人">
              <template #default="scope">
                <el-input v-model="scope.row.newName" autofocus></el-input>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="name" label="固话">
              <template #default="scope">
                <el-input v-model="scope.row.newName" autofocus></el-input>
              </template>
            </el-table-column>
            <el-table-column prop="createTime" label="邮编">
              <template #default="scope">
                <el-input v-model="scope.row.newName" autofocus></el-input>
              </template>
            </el-table-column>
