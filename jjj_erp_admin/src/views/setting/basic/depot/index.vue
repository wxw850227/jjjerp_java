<template>
	<div class="product bgset set-main">
		...
		<div class="common-seach-wrap">
			<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
				<el-form-item label="仓库编码">
					<el-input size="small" clearable v-model="searchForm.code" placeholder="请输入编码"
						class="form_content_width"></el-input>
				</el-form-item>
				<el-form-item label="仓库名称">
					<el-input size="small" clearable v-model="searchForm.name" placeholder="请输入名称"
						class="form_content_width"></el-input>
				</el-form-item>
		...
		<div class="common-level-rail d-b-c">
			<div class="d-s-c flex-1">
				<el-button size="small" type="primary" icon="Plus" @click="addClick"
					v-auth="'/setting/basic/depot/add'">新增</el-button>
			</div>
		...
		<el-table class="flex-1" size="small" :data="tableData" border style="width: 100%"
			...
			<el-table-column prop="depotId" label="ID" width="55"></el-table-column>
			...
			<el-table-column prop="name" label="仓库名称" width="100"></el-table-column>
			<el-table-column prop="type" label="仓库类型">
				<template #default="scope">
					<el-text size="small" v-if="scope.row.type == 0">正品仓</el-text>
					<el-text size="small" v-if="scope.row.type == 1">次品仓</el-text>
					<el-text size="small" v-if="scope.row.type == 2">门店仓</el-text>
				</template>
			</el-table-column>
			...
			<el-table-column prop="region" label="区" show-overflow-tooltip></el-table-column>
