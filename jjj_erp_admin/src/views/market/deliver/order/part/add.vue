<template>
	<el-dialog title="添加单据" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
		...
		<div class="common-seach-wrap column-dialog">
			...
			<el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
				<el-row>
					...
					<el-col :span="6"><el-form-item label="备注">
							<el-input size="small" v-model="searchForm.remark" placeholder=""
								></el-input> </el-form-item></el-col>
				</el-row>
				<el-row>				
					<el-col :span="5"><el-form-item label="订单号">
							<el-input size="small" v-model="searchForm.linkBillNum" placeholder="请输入订单号"></el-input>
						</el-form-item></el-col>
					<el-col :span="4">
						<el-form-item label="选择客户">
							<el-select v-model="searchForm.customerId" @change="fetchAddressList" placeholder="请选择">
					...
					<el-col :span="9">
						<el-form-item label="客户地址">
							<el-select v-model="searchForm.customerAddressId" clearable placeholder="请选择">
            ...
            <el-form-item label="客户昵称">
              <el-select v-model="searchForm.customerId" placeholder="请选择">
                <el-option
		...
		<el-table size="small" :data="productData" border style="width: 100%" @selection-change="handleSelectionChange"
			...
			<el-table-column prop="imageUrl" label="图" width="42">
				<template #default="scope">
					<el-image v-if="scope.row.imageUrl" style="width: 26px; height: 26px;display: block;" :src="scope.row.imageUrl"
						:preview-src-list="[scope.row.imageUrl]">
					</el-image>
					<el-image v-else style="width: 26px; height: 26px" src="/static/imgs/imagerror.png">
					</el-image>
				</template>
			</el-table-column>
      ...
      ></el-table-column> -->
			...
			<!-- <el-table-column prop="remark" label="销售金额小计">
        <template #default="{ row }">
          <el-input v-model="row.remark" label="备注" />
        </template>
      </el-table-column> -->
			<!-- <el-table-column prop="remark" label="货位编码">
        <template #default="{ row }">
          <el-input v-model="row.remark" label="货位编码" />
        </template>
      </el-table-column> -->
...
<script>
	...
	export default {
		...
		props: ["open_add", "addForm", "businessType", "customerList"],
		created() {
			...
			//   item.availableNumber = item.operNumber;
			//   item.availableAllNumber = item.basicNumber;
			// });
		...
		methods: {
			...
			editUser() {
				...
				console.log(params, "params");
				self.loading = true;
				MarketApi.deliverOrderAdd(params, true)
					.then((data) => {
						self.loading = false;
						ElMessage({
							message: "添加成功",
