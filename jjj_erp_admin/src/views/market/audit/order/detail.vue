<template>
	<el-dialog title="订单详情" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
							...
							<el-row>
								<el-col :span="8">
									<el-form-item label="收货人" class="ww100">
										<el-input v-model="addressForm.name" size="small" placeholder="请输入收货人姓名"></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="8">
...
<script>
	...
	export default {
		...
		methods: {
			...
			/*上传*/
			openUpload(e) {
				if (!this.searchForm.fileList.some((file) => file.filePath)) {
