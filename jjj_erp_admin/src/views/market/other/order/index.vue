	...
	<div class="product bgset set-main">
		...
		<div class="common-seach-wrap">
          ...
          <el-select
            ...
            placeholder="请选择"
          >
            <el-option label="销售出库单" :value="1"></el-option>
            <el-option label="线下出库单" :value="2"></el-option>
          </el-select>
        </el-form-item> -->
		...
		<div class="common-level-rail d-b-c">
			<div class="d-s-c flex-1">
				<el-button size="small" type="primary" icon="Printer" @click="printClick"
					v-auth="'/product/base/unit/delete'">打印</el-button>
			</div>
		...
		<el-table size="small" class="flex-1" :data="tableData" border style="width: 100%"
			...
			<el-table-column prop="totalNum" label="商品总数" width="100"></el-table-column>
			<!-- <el-table-column
            prop="otherUnit"
            label="打印状态"
            width="100"
          ...
          ></el-table-column> -->
            ...
            width="100"
          ></el-table-column> -->
			<el-table-column prop="linkBillNum" label="订单号" width="140"  show-overflow-tooltip></el-table-column>
			<!-- <el-table-column
            prop="depotName"
            label="标记"
            width="100"
          ...
          ></el-table-column> -->
            ...
            width="100"
          ></el-table-column> -->
			<el-table-column prop="systemRemark" label="系统备注" width="100" show-overflow-tooltip></el-table-column>
          ...
          <el-table-column prop="purchaseMoney" label="体积"></el-table-column> -->
			...
			<el-table-column prop="customerName" label="收件人"></el-table-column>
			...
			<el-table-column prop="orderTime" label="打单时间" show-overflow-tooltip></el-table-column>
          ...
          <el-table-column prop="name" label="完成时间"></el-table-column> -->
			...
			<el-table-column prop="linkBillNum" label="配货单号" width="140" show-overflow-tooltip></el-table-column>
			<!-- <el-table-column
            prop="updateTime"
            label="原始平台"
          ></el-table-column> -->
	...
	export default {
		...
		methods: {
			...
			getData(param = "") {
				...
				MarketApi.otherOrderIndex(Params, true)
					.then((res) => {
						self.loading = false;
			...
			authClick() {
				...
				ElMessageBox.confirm("确认发货吗?", "友情提示", {
						confirmButtonText: "确定",
						cancelButtonText: "取消",
						type: "warning",
					})
