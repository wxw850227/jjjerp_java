	...
	<div class="product bgset set-main">
		...
		<div class="common-level-rail d-b-c">
			<div class="d-s-c flex-1">
				<el-button size="small" type="primary" icon="Printer" @click="authClick"
					v-auth="'/product/base/unit/add'">打印</el-button>
			</div>
		...
		<el-table class="flex-1" size="small" :data="tableData" border style="width: 100%"
			...
			<el-table-column prop="otherUnit" label="商品总数" width="100"></el-table-column>
			<!-- <el-table-column
            prop="otherUnit"
            label="打印状态"
            width="100"
          ...
          ></el-table-column> -->
			...
			<el-table-column prop="deliveryList[0].expressNo" label="快递单号" width="100" show-overflow-tooltip></el-table-column>
          ...
          <el-table-column prop="name" label="完成时间"></el-table-column> -->
			...
			<el-table-column prop="linkBillNum" label="配货单号" show-overflow-tooltip></el-table-column>
			<!-- <el-table-column
            prop="updateTime"
            label="原始平台"
          ></el-table-column> -->
	...
	export default {
		...
		methods: {
			...
			getData(param = "") {
				...
				MarketApi.otherOrderDeliverIndex(Params, true)
					.then((res) => {
						self.loading = false;
