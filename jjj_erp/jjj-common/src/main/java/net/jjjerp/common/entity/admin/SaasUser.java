...
package net.jjjerp.common.entity.admin;
...
@TableName("jjjerp_saas_user")
@ApiModel(value = "SaasUser对象", description = "saas管理员用户")
public class SaasUser implements Serializable {
    ...
    @TableId(value = "saas_user_id", type = IdType.AUTO)
