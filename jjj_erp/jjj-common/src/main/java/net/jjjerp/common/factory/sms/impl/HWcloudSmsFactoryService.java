package net.jjjerp.common.factory.sms.impl;

import com.alibaba.fastjson.JSONObject;
import lombok.extern.slf4j.Slf4j;
import net.jjjerp.common.enums.SettingEnum;
import net.jjjerp.common.factory.sms.SmsFactoryService;
import net.jjjerp.common.settings.vo.SmsVo;
import net.jjjerp.common.util.HuaWeiSMSUtil;
import net.jjjerp.common.util.SettingUtils;
import net.jjjerp.common.vo.sms.HwSmsRoot;
...
public class HWcloudSmsFactoryService extends SmsFactoryService {
    ...
    public Boolean sendSms(String mobile, String templateCode, JSONObject templateParam)  {
        // 短信设置
